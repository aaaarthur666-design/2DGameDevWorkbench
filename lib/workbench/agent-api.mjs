...
export async function agentRequest(manifest, operation, input = {}) {
  ...
  if (operation === 'frontend-context') return frontendContext(repositoryRoot, manifest, previewInputs[operation].parse(input));
  if (operation === 'present') {
    ...
    return { ...(await queuePresentation(repositoryRoot, manifest, presentation)),
